    ...
    <div class = "login-content">
          ...
          <p id = "description"> Enter your email to begin <p>
            ...
            <div class = "input">
              ...
              <div class = "title"> USERNAME </div>
                    <input class = "text" type = "text" name = "username" placeholder = "Username" v-model.trim.lazy ="username" required>
            </div>
      ...
      <div class="tabs">
          <label class="tab" for="link-to-staff">
            <div class="text"> Not a Student? Login as a Staff instead </div>
          </label>
